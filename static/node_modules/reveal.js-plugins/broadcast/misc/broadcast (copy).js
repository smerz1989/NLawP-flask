...
//alert("!");
		...
		// Receive custom event
			...
			console.log("Received: " + message.customMessage + " from " + message.sender );
                });
...
/// Sender
	document.onkeypress =  function post(event) {
		console.log("Key pressed: ", event.key);
//		connection.sendCustomMessage({ userOnline: true, userid: connection.userid });
//                    var customMessage = prompt('Enter test message.');
                var socket = connection.getSocket();
                socket.emit(connection.socketCustomEvent, {
                        sender: connection.userid,
//                        customMessage: customMessage
                        customMessage: event.key
                });
	};
