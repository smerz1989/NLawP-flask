...
console.log("getUserMedia (open prompt)");
            if (!session) {
                session = connection.session;
            }

            if (!localMediaConstraints) {
console.log("Use mediaConstraints",JSON.stringify(connection.mediaConstraints));
                localMediaConstraints = connection.mediaConstraints;
            }

            getUserMediaHandler({
                onGettingLocalMedia: function(stream) {
console.log("localMediaConstraints",JSON.stringify(localMediaConstraints))
